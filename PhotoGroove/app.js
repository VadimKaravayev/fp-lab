...
var $author$project$PhotoGroove$photosListUrl = 'http://elm-in-action.com/photos/list.json';
var $author$project$PhotoGroove$initialCmd = $elm$http$Http$get(
	{
		...
		url: $author$project$PhotoGroove$photosListUrl
	});
var $author$project$PhotoGroove$Large = {$: 'Large'};
var $author$project$PhotoGroove$Loading = {$: 'Loading'};
var $author$project$PhotoGroove$initialModel = {activity: '', chosenSize: $author$project$PhotoGroove$Large, hue: 5, noise: 5, ripple: 5, status: $author$project$PhotoGroove$Loading};
	...
	switch (_v0.$) {
		case 'Loaded':
			...
			var filters = _List_fromArray(
				[
					{
					amount: toAmount(model.hue),
					name: 'Hue'
				},
					{
					amount: toAmount(model.ripple),
					name: 'Ripple'
				},
					{
					amount: toAmount(model.noise),
					name: 'Noise'
				}
				]);
				...
				if (msg.a.$ === 'Ok') {
					...
					if (photos.b) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									status: $author$project$PhotoGroove$Errored('Found 0 photo')
								}),
							$elm$core$Platform$Cmd$none);
					}
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								status: $author$project$PhotoGroove$Errored('failed to get photos')
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'SlidHue':
		...
		function () {
			...
			switch (_v0.$) {
				...
				default:
					...
					return _List_fromArray(
						[
							$elm$html$Html$text('Error: ' + errorMsg)
						]);
			}
		}());
};
